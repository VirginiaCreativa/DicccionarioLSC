...
export const GET_TAGS_DEPARTAMENTO = 'GET_TAGS_DEPARTAMENTO';

export const REMOVE_TAGS_MANOS = 'REMOVE_TAGS_MANOS';
export const REMOVE_TAGS_UBICACION = 'REMOVE_TAGS_UBICACION';
